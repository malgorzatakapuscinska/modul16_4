    ...
    _createClass(App, [{
        ...
        value: function removeToDo(id) {
            var remainder = this.state.data.filter(function (todo) {
                return todo.id !== id;
            }); //filter returns array that contains all todo except todo with id that function get as parameter
        ...
        value: function render() {
            return _react2.default.createElement(
                ...
                _react2.default.createElement(_TodoList2.default, { todoItems: this.state.data, removeTodo: this.removeTodo })
            );
        }
    }]);
...
var TodoList = function (_React$Component) {
	...
	_createClass(TodoList, [{
		...
		get: function get() {
			...
			return this.props.todoItems.map(function (todo) {
				return _react2.default.createElement(_Todo2.default, { key: todo.id, text: todo.text, remove: _this2.props.removeTodo });
			});
		}
	}]);
...
var Todo = function Todo(props) {
	_react2.default.createElement(
		...
		_react2.default.createElement(
			'button',
			{ onclick: undefined.props.remove },
			'x'
		)
	);
};
